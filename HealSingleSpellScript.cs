...
public class HealSingleSpellScript : SpecificSpellNew
{
    ...
    public override void spellAffectOnSpecificTroopPolymorphic()
    {
        ...
        if (troop.CompareTag("team1"))
        {
            GameObject contactCollider = troop.transform.Find("ContactCollider").gameObject;
            contactCollider.GetComponent<AllEffectsOnTroop>().AddToList(new InstantHeal(troop, 4));
